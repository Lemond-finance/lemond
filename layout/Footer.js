    ...
    return (
        <footer className={styles.footer}>
            <ul>
                ...
                <li onClick={() => window.open("https://t.me/lemondok")}><i className={styles.telegram}></i></li>
                <li onClick={() => window.open("https://github.com/Lemond-finance/lemond")}><i className={styles.github}></i></li>
            </ul>
        </footer>
    )
}
