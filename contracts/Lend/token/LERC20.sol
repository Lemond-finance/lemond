...
import "./LERC20Storage.sol";
import "../flashloan/IFlashloan.sol";

contract LERC20 is LToken, ILERC20, LERC20Storage {
    ...
    function initialize(address underlying_,
        ...
        // LToken initialize does the bulk of the work
     ...
     * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
     */
    function liquidateBorrow(address borrower, uint repayAmount, ILToken cTokenCollateral) external override returns (uint) {
