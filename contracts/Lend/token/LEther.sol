...
contract LEther is LToken {
    ...
    function liquidateBorrow(address borrower, LToken lTokenCollateral) external payable {
        (uint err,) = liquidateBorrowInternal(borrower, msg.value, lTokenCollateral);
